...
import { LandingPage } from "@guitos/application/react/sections/LandingPage/LandingPage";
...
const ChartsPage = lazy(
  () => import("@guitos/application/react/sections/ChartsPage/ChartsPage"),
);
const TableCard = lazy(
  () => import("@guitos/application/react/sections/TableCard/TableCard"),
);
const ErrorModal = lazy(
  () => import("@guitos/application/react/sections/ErrorModal/ErrorModal"),
);
